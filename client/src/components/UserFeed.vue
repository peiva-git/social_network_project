  ...
  <div class="container-fluid" v-if="error">
    ...
    <div class="d-flex align-items-center">
      <div class="flex-shrink-0 me-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="auto" fill="currentColor" class="bi bi-envelope-exclamation-fill" viewBox="0 0 16 16">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary position-relative" @click.prevent="toggleLike(message)">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16" v-else>
          ...
          <div class="card-footer text-muted">{{(new Date(message.date)).toLocaleDateString()}} - {{(new Date(message.date)).toLocaleTimeString()}}</div>
        </div>
      </div>
    </div>
  </div>
